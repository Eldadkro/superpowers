...
**Personal skills live in agent-specific directories. Follow your harness's native skill location and put project-specific instructions in `AGENTS.md`.**
...
**Vendor appendix:** Anthropic-specific guidance lives in `vendor/anthropic-best-practices.md`. Treat it as vendor reference material, not core superpowers doctrine.
